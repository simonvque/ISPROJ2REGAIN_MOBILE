        ...
        appBar: buildAppBar(context, 'Penalty Points',
         tabBar: TabBar(
          ...
          labelStyle: Theme.of(context).textTheme.titleMedium,
            tabs: const [
              Tab(icon: Icon(CupertinoIcons.gauge), text: 'Credit Score', ),
...
class ReportsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Report> reports = [
      Report('Report User: Inappropriate behavior', 'Reported on: 2024-07-01', 'Reviewing'),
      Report('Report Listing: Spam listing', 'Reported on: 2024-06-30', 'Resolved'),
      Report('Report User: Inappropriate behavior', 'Reported on: 2024-07-01', 'Reviewing'),
      Report('Report Listing: Spam listing', 'Reported on: 2024-06-30', 'Resolved'),
      Report('Report User: Inappropriate behavior', 'Reported on: 2024-07-01', 'Reviewing'),
      Report('Report Listing: Spam listing', 'Reported on: 2024-06-30', 'Resolved'),
    ...
    return Padding(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
              title: Text(report.title, style: Theme.of(context).textTheme.titleLarge),
              subtitle: Text(report.subtitle, style: Theme.of(context).textTheme.labelMedium),
              trailing: Text(report.status, style: Theme.of(context).textTheme.bodyMedium?.copyWith(
          ...
          showModalBottomSheet(
            ...
            builder: (BuildContext context) {
              return ReportDetailsModal(
                ...
                adminMessage: 'This is a message from the admin regarding the report. It could be a detailed response or instructions.',
