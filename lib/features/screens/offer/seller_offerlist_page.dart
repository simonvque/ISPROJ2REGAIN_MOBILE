...
class SellerOfferList extends StatelessWidget {
  ...
  final Map<int, List<BuyerOffer>> buyerOffers = {
    //product id 1
    1: [
      BuyerOffer(buyerUsername: 'Buyer1', offerPrice: '140.0', offerStatus: 'Pending'),
      BuyerOffer(buyerUsername: 'Buyer2', offerPrice: '150.0', offerStatus: 'Pending'),
      BuyerOffer(buyerUsername: 'Buyer1', offerPrice: '140.0', offerStatus: 'Pending'),
      BuyerOffer(buyerUsername: 'Buyer2', offerPrice: '150.0', offerStatus: 'Pending'),
      BuyerOffer(buyerUsername: 'Buyer1', offerPrice: '140.0', offerStatus: 'Pending'),
      BuyerOffer(buyerUsername: 'Buyer2', offerPrice: '150.0', offerStatus: 'Pending'),
    ...
    //product id 2
    2: [
      BuyerOffer(buyerUsername: 'Buyer3', offerPrice: '240.0', offerStatus: 'Pending'),
      BuyerOffer(buyerUsername: 'Buyer4', offerPrice: '250.0', offerStatus: 'Pending'),
    ],
  };
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            onTap: () {
                ...
                ViewProduct product = sellerProducts.firstWhere((product) => product.productID == productId);
                
                // Get the list of buyer offers for the current productId
                List<BuyerOffer> buyerOffersList = buyerOffers[productId] ?? [];
                      Navigator.push(
                          context,
                          MaterialPageRoute(
